...
$reclamation = $reclamationController->listReclamation();
...
$reponseController = new ReponseController();
    ...
    if (isset($_POST["date_reponse"]) && $_POST["reponse"] && $_POST["id_reclamations"] )
     {
        if (
            !empty($_POST["date_reponse"]) && !empty($_POST["reponse"]) && !empty($_POST["id_reclamations"])
        ) {
...
<body>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-bell font-24"></i>
                             ...
                             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="showReponse.php">reponse</a>
    ...
    <input type="text" id="searchById" placeholder="Search by ID..." onkeyup="searchReclamations()">
</div>
<script>
function searchReclamations() {
    var input = document.getElementById('searchById').value;
    var filter = input.toLowerCase();
    var reclamationItems = document.querySelectorAll('.reclamation-item');

    reclamationItems.forEach(function(item) {
        var id = item.querySelector('h2').textContent.split(' #')[1]; // Get the ID from the h2 tag
        if (id && id.toLowerCase().includes(filter)) {
        ...
        <div class="reclamation-list">
            ...
            if ($reclamation) {
                foreach ($reclamation as $reclamation) {
                    ...
                    echo '<h2>Réclamation #' . $reclamation['id'] . '</h2>';
                    echo '<p><strong>Nom : </strong>' . htmlspecialchars($reclamation['nom']) . ' ' . htmlspecialchars($reclamation['prenom']) . '</p>';
                    echo '<p><strong>telephone : </strong>' . htmlspecialchars($reclamation['telephone']) . '</p>';
...
<div class="popup" id="popup-<?php echo $reclamation['id']; ?>">
    <div class="popup-content">
        <h2>Reponse</h2>
        <form id="reponseForm-<?php echo $reclamation['id']; ?>" action="" method="POST">
            <div>
                <input type="hidden" id="id_reclamations" name="id_reclamations" value="<?php echo $reclamation['id']; ?>">
                <div>
                    <input type="date" id="date_reponse" name="date_reponse">
                </div>
                <textarea placeholder="Leave a message here" id="reponse" name="reponse" style="width: 460px"></textarea>
                <div>
