        ...
        <!-- Navbar & Hero End -->
                  <table class="table">
                        ...
                        foreach ($reclamation as $reclamation) {
                            ...
                            echo "<td>" . htmlspecialchars($reclamation['prenom']) . "</td>";
                            echo "<td>" .htmlspecialchars($reclamation['telephone']) . "</td>";
                            echo "<td>" . htmlspecialchars($reclamation['email']) . "</td>";
                            echo "<td>" . htmlspecialchars($reclamation['dates']). "</td>";
                            echo "<td>" . htmlspecialchars($reclamation['messages']) . "</td>";
                            ?>
                            <td>
                            <a href="showReponse.php?id=<?php echo $reclamation['id']; ?>">read reponse</a></td>
                            <?php
                            echo "</tr>";
                        }
                        ?>
