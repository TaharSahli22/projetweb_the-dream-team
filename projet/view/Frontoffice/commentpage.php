            ...
            <a href="" class="navbar-brand p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="blogtem.php" class="nav-item nav-link active">Blogs</a>
            ...
            <form id="reportCommentForm" method="POST" action="reportComment.php">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="reportUser" name="user" value="<?php echo $_SESSION['user_nom']; ?>" readonly required>
                    </div>
                    <div class="mb-3">
...
if (!empty($comments)) {
  ...
  <span class="leftContainer">
    ...
    <span class="likeCount" id="likes-<?php echo $comment['id']; ?>">
        ...
        <?php if($comment['user']==$_SESSION['user_nom']){ ?>
...
<form id="comform" action="send_message.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-12">
        ...
        <?php if(!empty($_SESSION['user_nom'])){ ?>
            <input type="text" class="form-control border-0" id="user" name="user" value="<?php echo $_SESSION['user_nom']; ?>" readonly>
            <?php }?>
            <?php if(empty($_SESSION['user_nom'])) {?>
                <input type="text" class="form-control border-0" id="user" name="user" value="annonyme" readonly>
                <?php }?>
