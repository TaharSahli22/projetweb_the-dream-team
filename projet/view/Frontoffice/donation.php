    ...
    <body>
        ...
        <form action="../Backoffice/dsubmit.php" method="POST"> 
            ...
            <div class="mb-3">
                ...
                <!-- reCAPTCHA -->
    <div class="g-recaptcha" data-sitekey="6LdF7JYqAAAAAEyRTP37RoTU7dpi5_UfcWN6pWnr"></div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $secretKey = '6LdF7JYqAAAAAMoTvUklnJBJKr46m0Mccaq0t00Y';
...
?>
   ...
   <!-- <a href="chatbot/index.html" target="_blank" id="ia-assistant-icon" class="position-fixed bottom-0 end-0 m-4">
    ...
    <audio id="successAudio" src="./assets/success.mp3"></audio>
    <audio id="errorAudio" src="./assets/error.mp3"></audio>

<script>
    // JavaScript to handle form submission and play audio
    document.getElementById("donationForm").addEventListener("submit", function (e) {
        ...
        // Basic validation logic (you can customize this)
        ...
        if (fullName && email && phone && bankName && accountNumber && iban && donationAmount > 0) {
            // If all fields are filled correctly
            successAudio.play(); // Play success audio
            setTimeout(() => {
                this.submit(); // Submit the form after audio plays
            }, 1000); // Delay submission slightly to allow audio playback
        } else {
            // If validation fails
