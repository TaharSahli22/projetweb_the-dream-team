                    ...
                    <div class="d-inline-flex align-items-center" style="height: 45px;">
                        <?php if (isset($_SESSION['user_id'])) { ?>
                            ...
                            <div class="dropdown-menu rounded">
                                <a href="#" class="dropdown-item"><i class="fas fa-user-alt me-2"></i> <?php echo htmlspecialchars($_SESSION['user_name']); ?></a>
                                <a href="../back_office/logout.php" class="dropdown-item"><i class="fas fa-power-off me-2"></i> Log Out</a>
                            </div>
                        </div>
                        <?php }else{ ?>
                        <a href="sig_in.php"><small class="me-3 text-dark"><i class="fa fa-user text-primary me-2"></i>Register</small></a>
                        <a href="../back_office/log_in.php"><small class="me-3 text-dark"><i class="fa fa-sign-in-alt text-primary me-2"></i>Login</small></a>
                        <?php } ?>
