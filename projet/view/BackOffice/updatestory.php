...
<html lang="en">
    ...
    ?>
                                            ...
                                            <input class="form-control form-control-user" type="text" id="id" name="id" readonly value="<?php echo $_POST['id'] ?>">
                                                ...
                                                <input class="form-control form-control-user" type="text" id="dates" name="dates" value="<?php echo $story['dates'] ?>" readonly >
                                        
                                        
                                                <label for="adminuser">adminuser :</label><br>
                                                <input class="form-control form-control-user"  type="test" id="adminuser" name="adminuser" value="<?php echo $story['adminuser'] ?>">
                                                ...
                                                <input class="form-control form-control-user"  type="file" id="eventimage" name="eventimage" value="<?php echo $story['eventimage'] ?>">
