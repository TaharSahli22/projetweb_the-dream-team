...
<body>  
<a href="../FrontOffice/index.php" style="color:#2ecc71;font-weight:bold;font-size:25px;text-decoration:none;margin-left:50px">Stocker</a>
...
<section class="wrapper">
    ...
    <div class="form login">    
        ...
        <form id="loginForm" method="post" action="">
            ...
            <a href="../FrontOffice/sig_in.php" style="text-decoration:none;color:#2ecc71;">Register</a>
        </form>
    </div>
</section>
