...
if (
    isset($_POST["title"])  && $_POST["subjects"] && $_POST["dates"] && $_POST["adminuser"]&& $_POST["likes"]
) {
    if (
        !empty($_POST["title"])  && !empty($_POST["subjects"]) && !empty($_POST["dates"])  && !empty($_POST["adminuser"] &&  !empty($_POST["likes"]))
        ...
        $blogController->updatestory($story, $_POST['id']);
                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Update story with Id = <?php echo $_POST['id'] ?> </h1>
                                  </div>
                            ...
                            <div class="col-xl-12 col-md-6 mb-4">
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        ...
                                        <?php
    if (isset($_POST['id'])) {
        $story = $blogController->showstory($_POST['id']);
       
    ?>
                                            <form id="addstoryForm" action="" method="POST">
                                            <label for="id">ID stroy:</label><br>
                                            <input class="form-control form-control-user" type="text" id="id" name="id" readonly value="<?php echo $_POST['id'] ?>">
                                                <label for="title">Title:</label><br>
                                                <input class="form-control form-control-user" type="text" id="title" name="title" value="<?php echo $story['title'] ?>" >
                                                <span id="title_error"></span><br>
                                             
                                        
                                                <label for="subjects">subjects:</label><br>
                                                <input class="form-control form-control-user" type="text" id="subjects" name="subjects" value="<?php echo $story['subjects'] ?>" >
                                                <span id="subjects_error"></span><br>


                                                <label for="dates">dates:</label><br>
                                                <input class="form-control form-control-user" type="text" id="dates" name="dates" value="<?php echo $story['dates'] ?>" >
                                        
                                        
                                                <label for="adminuser">adminuser :</label><br>
                                                <input class="form-control form-control-user"  type="test" id="adminuser" name="adminuser" step="0.01" value="<?php echo $story['adminuser'] ?>">
                                                <span id="adminuser_error"></span><br>
                                        
                                                <label for="likes">likes:</label><br>
                                                <input class="form-control form-control-user" type="text" id="likes" name="likes" value="<?php echo $story['likes'] ?>" >
