...
<?php
    $story = $blogController->showstory($stryid);
                    ...
                    echo '<p class="mb-0">BLOG ID :' . htmlspecialchars($story['id']) . '</p>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
?>
<div class="comment-section">
    ...
    <table class="table">
                        ...
                        foreach ($comments as $comment) {
                            echo "<tr>";
                            echo "<td>" . htmlspecialchars($comment['user']) . "</td>";
                            echo "<td>" .htmlspecialchars($comment['dates']) . "</td>";
                            echo "<td>";
                            ...
                            echo "</td>";
                            echo "<td>" .  htmlspecialchars($comment['likes']) . "</td>";
                            echo "<td>" . htmlspecialchars($comment['id']). "</td>";
                            ?>
                           <td><a href="deletecom.php?id=<?php echo $comment['id']; ?>" class="btn">delete</a></td>
                           <?php
                            echo "</tr>";
                        }
                        ?>
