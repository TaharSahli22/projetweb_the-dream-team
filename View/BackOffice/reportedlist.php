...
$report = $comController->reportlist();
                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="blogdash.php">Home</a></li>
...
<div class="comment-section">
    ...
    <table class="table">
                        ...
                        foreach ($report as $report) {
                            ...
                            echo "<td>" .htmlspecialchars($report['comment_id']) . "</td>";
                            echo "<td>" . htmlspecialchars($report['reported_by']) . "</td>";
                            echo "<td>" .  htmlspecialchars($report['report_reason']) . "</td>";
                            echo "<td>" . htmlspecialchars($report['report_date']). "</td>";
                            ?>
                            <td>
                             <form method="POST" action="sendworning.php">
                <input type="hidden" name="report_id" value="<?php echo $report['comment_id']; ?>">
